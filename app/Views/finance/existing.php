                    ...
                    <div class="card-body pb-0">
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nokontrak</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="nokontrak" id="nokontrak" placeholder="Nokontrak" value="<?= old('nokontrak') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" data-date="" data-date-format="DD/MM/YYYY" name="tgl_akad" value="<?= old('tgl_akad') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="funding" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control currency" name="blokirangsuran" placeholder="0.00" value="<?= old('blokirangsuran') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#nokontrak").bind("paste", function(e) {
            var nokontrak = e.originalEvent.clipboardData.getData('text');
            delay(function() {
                $.ajax({
                    url: base_url + "detailExisting",
                    method: "POST",
                    dataType: "JSON",
                    data: {
                        nokontrak: nokontrak
                    ...
                    success: function(data) {
                        ...
                        if (data.status) {
                            ...
                            $('[name="id_produk"]').val(res.kdprd);
                            $('[name="tgl_akad"]').val(res.tglakad);
                            $('[name="pladond"]').val(res.osmdlc);
                        } else {
                            Swal.fire({
                                title: 'Warning',
                                text: "Data Nasabah tidak ditemukan. Periksa kembali Nokontrak!",
                                icon: 'warning',
